...
<body>
  <div class="container py-5 gy-4">
      ...
      <div class="col-md-5">
        <div class="card">
          <div class="card-header">
            <h5 class="text-primary fw-bold">HAKIKISHA NIDA:</h5>
          </div>
        ...
        <div class="border border-secodary  bg-white p-3 mt-2 text-dark  rounded-2 ">
   <p>If you need bulk NIN verification for your customers' KYC, contact us for an API endpoint which can be easily integrated into your business website for identity validation.</p>
            <p class="text-primary ">Send us an email at support@azacloud.com</p>
        </div>
  ...
  <!-- Custom JavaScript -->
  <script src="assets/js/app.amplifier.bundle.min.js"></script>
</body>
</html>
